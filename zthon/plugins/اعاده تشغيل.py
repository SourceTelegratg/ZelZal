...
async def _(event):
    ...
    await edit_or_reply(event, "**✾╎جــارِ إيقـاف تشغيـل بـوت 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙏𝙂 الآن 📟 ...**\n\n**✾╎شغِّـلنـي يـدويًـا لاحقًــا**\n**✾╎باتبـاع الشـرح** https://t.me/zzzlvv/20")
