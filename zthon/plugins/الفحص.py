...
async def amireallyalive(event):
    ...
    ALIVE_TEXT = gvarstatus("ALIVE_TEXT") or "** بـوت  الرادثن 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙏𝙂  يعمـل .. بنجـاح ☑️ 𓆩 **"
...
**{Z_EMOJI} قنـاة السـورس :** [اضغـط هنـا](https://t.me/ALRADTHEN)"""
...
async def amireallyialive(event):
    ...
    reply_to_id = await reply_id(event)
    Z_EMOJI = gvarstatus("ALIVE_EMOJI") or "✥┊"
    zed_caption = "** بـوت  الرادثن 𝙏𝙀𝙇𝙀𝙂𝙍𝘼𝙏𝙂  يعمـل .. بنجـاح ☑️ 𓆩 **\n"
