...
class Config(object):
    ...
    # Get this value by running python3 stringsetup.py or https://replit.com/@AbuAlSib/stringsession
    ...
    UPSTREAM_REPO = os.environ.get(
        "UPSTREAM_REPO", "https://github.com/SourceTelegratg/Zelzal"
    )
    # External plugins repo
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "no") and not url(EXTERNAL_REPO):
        EXTERNAL_REPO = "https://github.com/SourceTelegratg/ZedPlugins"
    ...
    OLDZED_REPO = os.environ.get("OLDZED_REPO", "https://github.com/SourceTelegratg/ZED_USERBOT")
